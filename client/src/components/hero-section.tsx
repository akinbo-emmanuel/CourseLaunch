    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center animate-fade-in-up">
          ...
          {/* Main Heading */}
          <h1 className="text-left md:text-center leading-[150%] text-3xl sm:text-4xl/[120%] lg:text-5xl/[120%] font-extrabold text-gray-900 mb-8">
            Transform Your
          ...
          {/* Subtitle */}
          <p className="md:text-center text-justify sm:text-lg lg:text-xl text-gray-700 mb-12 max-w-5xl mx-auto leading-relaxed font-light">
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 mb-16">
            <button
              ...
              className="group relative bg-gradient-to-r from-academic-blue-600 to-academic-blue-700 text-white px-4 md:px-10 py-5 rounded-sm text-sm md:text-base font-bold hover:from-academic-blue-700 hover:to-academic-blue-800 transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden flex items-center gap-2"
              data-testid="button-start-success-story"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
              <GraduationCap className="size-5 inline" />
              Start Your Success Story
            </button>
            <button
              onClick={scrollToInstructor}
              className="group text-academic-blue-600 hover:text-academic-blue-700 font-bold text-sm md:text-base transition-all duration-300 flex items-center"
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-6 max-w-4xl mx-auto">
            {perks.map((perk, index) => (
              <div
                key={index}
                className="group bg-white/80 backdrop-blur-sm rounded-sm md:rounded-xl md:p-6 p-2 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-academic-blue-100/50"
              ...
              >
                ...
                <div className="md:text-lg font-bold text-gray-900 mb-1">
                  {perk.main}
                </div>
